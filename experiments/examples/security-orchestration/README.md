...
This directory contains a complete implementation of the experimental [Security Orchestration](../../README.md#security-orchestration) pattern, aggregating multiple security tools and using AI to summarize findings for actionable insights.
