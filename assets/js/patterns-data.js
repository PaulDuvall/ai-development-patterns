...
window.PATTERNS_DATA = {
  ...
  "patterns": [
    ...
    },
    {
      ...
      "type": "Workflow",
      "category": "foundation",
      "shortDescription": "A staged, plan-first discipline for taking a single feature from problem to production with AI assistance",
      "dependencies": [
        {
          "name": "Codified Rules",
          "id": "codified-rules"
