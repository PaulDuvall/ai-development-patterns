# Code Research - Complete Implementation Guide

This directory contains a complete implementation guide for the **Code Research** pattern based on Simon Willison's approach to using fire-and-forget coding agents for autonomous code investigations.
...
The Code Research pattern enables developers to conduct 2-3 autonomous code investigations per day with minimal human oversight. Fire research prompts at async coding agents, let them work autonomously for 10-30 minutes, then review results when complete.
...
This repository follows the Code Research pattern from
