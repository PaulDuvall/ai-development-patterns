...
graph TB
    ...
    %% CLICKABLE LINKS
    click RA "?tab=readme-ov-file#readiness-assessment"
    click CR "?tab=readme-ov-file#codified-rules"
    click SS "?tab=readme-ov-file#security-sandbox"
    click DL "?tab=readme-ov-file#developer-lifecycle"
    click TI "?tab=readme-ov-file#tool-integration"
    click IG "?tab=readme-ov-file#issue-generation"
    click CP "?tab=readme-ov-file#context-persistence"
    click PE "?tab=readme-ov-file#progressive-enhancement"
    click SD "?tab=readme-ov-file#spec-driven-development"
    click AD "?tab=readme-ov-file#atomic-decomposition"
    click PA "?tab=readme-ov-file#parallel-agents"
    click OD "?tab=readme-ov-file#observable-development"
    click GR "?tab=readme-ov-file#guided-refactoring"
    click AT "?tab=readme-ov-file#automated-traceability"
    click PG "?tab=readme-ov-file#policy-generation"
    click SO "?tab=readme-ov-file#security-orchestration"
    click BM "?tab=readme-ov-file#baseline-management"
```
